...
public class FedoraContentIT extends AbstractResourceIT {
    ...
    public void testAddDatastream() throws Exception {
        ...
        assertEquals(
                ...
                serverAddress + "FedoraDatastreamsTest2/zxc/fcr:content",
                location);
    }
    ...
    public void testPutDatastream() throws Exception {
        final HttpPost objMethod =
                postObjMethod("FedoraDatastreamsTestPut");
        assertEquals(201, getStatus(objMethod));
        ...
        assertEquals(
                "Got wrong URI in Location header for datastream creation!",
                serverAddress + "FedoraDatastreamsTestPut/zxc/fcr:content",
                location);
    }
    ...
    public void testMutateDatastream() throws Exception {
        ...
        mutateDataStreamMethod.setEntity(new StringEntity(faulkner1,
                "UTF-8"));
        final HttpResponse response =
                client.execute(mutateDataStreamMethod);
    ...
    public void testRangeRequest() throws Exception {
        ...
        final HttpResponse response = client.execute(method_test_get);
        logger.debug("Returned from HTTP GET, now checking content...");
        assertEquals("Got the wrong content back!", "arb", EntityUtils
                .toString(response.getEntity()));
        assertEquals("bytes 1-3/20", response.getFirstHeader(
    ...
    public void testRangeRequestBadRange() throws Exception {
        ...
        final HttpResponse response = client.execute(method_test_get);
        assertEquals("bytes 50-100/20", response.getFirstHeader(
                "Content-Range").getValue());
